...
import photos from "../../src/components/photos/dashboard3.png";
    ...
    <div className="bg-primary">
      ...
      <div className="container-fluid d-flex flex-wrap ">
        <h1 className="display-1  text-light">
          Welcome to the BlackCoffer DashBoard!!{" "}
        ...
        ></img>
        <Link to="/dashboard" className="text-decoration-none text-dark mt-4">
          <button
